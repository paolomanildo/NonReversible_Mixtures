...
cloud_plot(figure8_top$MG, gg = TRUE)
cloud_plot(figure8_top$R, gg = TRUE)
cloud_plot(figure8_top$NR, gg = TRUE)
...
cloud_plot(figure8_bottom$MG, gg = TRUE)
cloud_plot(figure8_bottom$R, gg = TRUE)
cloud_plot(figure8_bottom$NR, gg = TRUE)
