...
spaghetti(apply(figure1$MG,c(1,3), max), title = "Marginal Gibbs", which_show = 36, gg = FALSE)
#spaghetti(apply(figure1$R,c(1,3), max), title = "Reversible", which_show = 18, gg = FALSE)
spaghetti(apply(figure1$NR,c(1,3), max), title = "Non-Reversible", which_show = 36, gg = FALSE)
